...
```{r}
brms::as_draws_df(b6.3) %>% round(digits = 2)
```

```{r}
brms::as_draws_df(b6.4) %>% round(digits = 2)
```
...
```{r}
brms::as_draws_df(b6.5) %>% round(digits = 2)
```
