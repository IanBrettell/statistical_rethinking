...
```{r, echo = F, out.width='60%', fig.cap = "The first thing to do is regularize. We don't want to use flat priors. We have to be skeptical. We have to build scepticiism into the models. Choose priors that only give us possible outcomes. That helps to regularise - to reduce overfitting. "}
knitr::include_graphics(file.path(slides_dir, '15.png'))
```
