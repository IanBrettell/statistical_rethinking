...
```{r 11.6}
# wrangle
bind_rows(brms::prior_draws(b11.1),
          brms::prior_draws(b11.1b)) %>% 
...
bind_rows(brms::as_draws_df(b11.4),
          brms::as_draws_df(b11.6)) %>% 
...
```{r}
# extract the samples
post <- brms::as_draws_df(b11.pois)
# wrangle
post %>%
